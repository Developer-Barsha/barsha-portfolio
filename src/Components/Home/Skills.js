        ...
        <div id='skills' className='grid bg-skills-bg bg-cover bg-no-repeat py-5 text-white lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 lg:px-12 px-5 my-10'>
            ...
            <div className='flex flex-col gap-2 p-6 text-white'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <progress className="progress progress-success bg-white w-56 h-4" value="86" max="100"></progress>
                </div>
                <div className='flex items-center gap-2'>
                    <p className="font-bold w-24">CSS</p>
                    <progress className="progress progress-error bg-white w-56 h-4" value="76" max="100"></progress>
                </div>
                <div className='flex items-center gap-2'>
