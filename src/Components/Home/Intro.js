        ...
        <section id='intro' className='pt-24 flex py-5 flex-col lg:px-12 px-6 lg:flex-row-reverse items-center mx-auto'>
            ...
            <div className='w-full lg:w-1/2'>
                ...
                <div className='flex gap-5'>
                    <a href='#about' className="mt-5 button-link my-btn uppercase text-primary font-bold text-center">About me</a>
                    <a href='#about' className="mt-5 button-link my-btn uppercase text-primary font-bold text-center">My Skills</a>
                </div>
            </div>
        </section>
    );
