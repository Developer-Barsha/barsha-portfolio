        ...
        <section id='about' className='py-5 lg:px-12 px-6 items-center mx-auto'>
            <div className='flex lg:flex-row flex-col gap-10 items-center'>
                <div className='lg:w-1/2 w-full'>
                    <img src="https://media.istockphoto.com/vectors/young-programmer-pointing-on-the-laptop-screen-programming-code-flat-vector-id943084854?k=20&m=943084854&s=612x612&w=0&h=uEaf1DCv71aEd9be9dfTZonurO2verE7GBOaXi9fri0=" className='w-full' alt="" />
                </div>
