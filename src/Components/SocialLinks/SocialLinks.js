        ...
        <div className='absolute bottom-0' style={{ zIndex: 10000 }}>
            <div className='flex gap-3 fixed bottom-12 p-3 right-3 text-xl text-primary'>
                <label className="swap text-center text-2xl w-10 h-10 text-white py-2 px-3 bg-primary mb-3 rounded-full">
                    ...
                    <div className="swap-on"><i className="fa-solid fa-circle-xmark"></i></div>
                    <div className="swap-off"><i className="fa-solid fa-eye"></i></div>
                </label>
                {
                    show &&
                    <ul className='flex mb-2 flex-col social justify-center bottom-2 p-3 right-3 text-xl bg-purple-200 shadow-gray-900 rounded gap-4 text-primary'>
